 ...
 * @author DELL
 */
public class UpdateNK extends javax.swing.JFrame {

    /**
     * Creates new form UpdateNK
     */
    public UpdateNK() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thay đổi thông tin nhân khẩu");
        ...
        manhankhauTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                manhankhauTextFieldActionPerformed(evt);
            }
        });
        ...
        tennhankhauTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tennhankhauTextFieldActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(ngaysinhDateChooser, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(huyButton, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(manhankhauTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 416, Short.MAX_VALUE)
                            .addComponent(tennhankhauTextField, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(socccdTextField, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(sodienthoaiTextField, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(mahokhauTextField, javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(quanhevoichuhoTextField, javax.swing.GroupLayout.Alignment.LEADING))
                        .addGap(100, 100, 100))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void manhankhauTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_manhankhauTextFieldFocusLost
        ...
        if (this.isVisible()) {
            String manhankhau = manhankhauTextField.getText();
            if (manhankhau.length() > 0) {
            } else if (manhankhau.length() == 0) {
                JOptionPane.showMessageDialog(rootPane, "Mã nhân khẩu không được để trống");
            }
        }
    }//GEN-LAST:event_manhankhauTextFieldFocusLost

    private void manhankhauTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manhankhauTextFieldActionPerformed
        // TODO add your handling code here:
        String inputText = manhankhauTextField.getText().trim();

        // Kiểm tra xem văn bản có rỗng không
        if (inputText.isEmpty()) {
            // Hiển thị thông báo nếu rỗng
            JOptionPane.showMessageDialog(this, "mã nhân khẩu không đúng, vui lòng nhập lại", "Lỗi", JOptionPane.ERROR_MESSAGE);
        } else {
            // Thực hiện xử lý khi có dữ liệu
            // TODO: Thêm mã xử lý khi có dữ liệu nhập vào đây
        }
    }//GEN-LAST:event_manhankhauTextFieldActionPerformed

    private void tennhankhauTextFieldFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tennhankhauTextFieldFocusLost
        // TODO add your handling code here:
        if (this.isVisible()) {
            String tennhankhau = tennhankhauTextField.getText();
            if (tennhankhau.length() > 0) {
            } else if (tennhankhau.length() == 0) {
                JOptionPane.showMessageDialog(rootPane, "Mã nhân khẩu không được để trống");
            }
        }
    }//GEN-LAST:event_tennhankhauTextFieldFocusLost

    private void tennhankhauTextFieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tennhankhauTextFieldActionPerformed
        // TODO add your handling code here:
        String inputText = tennhankhauTextField.getText().trim();
    ...
    }//GEN-LAST:event_tennhankhauTextFieldActionPerformed
    ...
    private void themButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_themButtonActionPerformed
        ...
        if (x == JOptionPane.YES_OPTION) {
            ...
            maNhanKhau = manhankhauTextField.getText();
            tenNhanKhau = tennhankhauTextField.getText();
            soCccd = socccdTextField.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateNK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
